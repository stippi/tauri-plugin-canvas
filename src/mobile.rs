...
impl<R: Runtime> Canvas<R> {
    pub fn show_canvas(&self, config: CanvasConfig) -> crate::Result<()> {
        self.0
            .run_mobile_plugin("showCanvas", config)
            .map_err(Into::into)
    }
    ...
    pub fn activate_pen(&self, config: PenConfig) -> crate::Result<()> {
        self.0
            .run_mobile_plugin("activatePen", config)
            .map_err(Into::into)
    }
    ...
    pub fn undo(&self) -> crate::Result<()> {
        self.0
            .run_mobile_plugin::<()>("undo", ())
            .map_err(Into::into)
    }

    pub fn redo(&self) -> crate::Result<()> {
        self.0
            .run_mobile_plugin::<()>("redo", ())
            .map_err(Into::into)
    }
    ...
    pub fn begin_stroke_fade(&self, options: StrokeFadeOptions) -> crate::Result<()> {
        self.0
            .run_mobile_plugin("beginStrokeFade", options)
            .map_err(Into::into)
    }

    pub fn end_stroke_fade(&self, options: StrokeFadeOptions) -> crate::Result<()> {
        self.0
            .run_mobile_plugin("endStrokeFade", options)
            .map_err(Into::into)
    }
}
